   ...
   JButton add,back;
    AddCustomer(){
       ...
       lblid.setFont(new Font("Raleway",Font.PLAIN,20));
        ...
        String options[]={"Aadhaar Card","Passport","Driving License","Voter ID"};
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() ==add){
            ...
            try{
                String query="insert into customers values('"+id+"','"+number+"','"+name+"','"+gender+"','"+country+"','"+room+"','"+time+"','"+deposit+"')";
