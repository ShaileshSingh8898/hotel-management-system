...
public class AddRooms extends JFrame implements ActionListener {
   ...
   JComboBox availablecombo,typecombo,cleancombo;
    ...
    AddRooms(){
       ...
       lblavailable.setBounds(60,130,940,30);
        add(lblavailable);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==add){
            ...
            try{
                Conn conn=new Conn();
                String str="insert into room (roomnumber,availability,status,price,type)values ('"+roomnumber+"','"+availability+"','"+status+"','"+price+"','"+type+"')";
